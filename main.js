function startClassification()
{
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/8oExVGhLK/main.json', modelReady);
}
